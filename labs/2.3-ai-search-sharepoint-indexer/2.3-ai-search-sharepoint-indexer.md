...
In this lab, you will configure Azure AI Search to index documents directly from SharePoint document libraries and use this indexed content as a knowledge source for your Copilot Studio agent. Please note that this feature is in preview and is not recommended for production scenarios.
